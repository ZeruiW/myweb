...
function TimelineItem({ experience }: { experience: (typeof experienceData)[0] }) {
  ...
  return (
    <div className="relative pb-8 pl-8 last:pb-0">
      {/* Timeline line */}
      <div className="absolute top-3 left-[11px] h-full w-0.5 bg-gray-200 dark:bg-gray-800" />

      {/* Timeline dot */}
      <div
        className={`absolute top-1.5 left-0 h-6 w-6 rounded-full ${typeColors[experience.type]} flex items-center justify-center ring-4 ring-white dark:ring-gray-950`}
      >
        ...
        {experience.achievements && experience.achievements.length > 0 && (
          <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
            {experience.achievements.map((achievement) => (
              <div
                key={achievement}
                className="bg-primary-50 dark:bg-primary-950/30 rounded-lg px-3 py-2 text-center"
              >
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900/50">
      <div className="flex items-center gap-3">
        <div className="bg-primary-100 text-primary-600 dark:bg-primary-900/50 dark:text-primary-400 flex h-10 w-10 items-center justify-center rounded-lg">
          {icon}
        </div>
        <div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6 text-center dark:border-gray-800 dark:bg-gray-900/50">
                <div className="from-primary-500 to-primary-600 mx-auto h-32 w-32 overflow-hidden rounded-full bg-gradient-to-br">
                  <Image
          ...
          <div className="space-y-12 lg:col-span-2">
            ...
            <section>
              ...
              <p className="mb-6 leading-relaxed text-gray-600 dark:text-gray-400">
                I specialize in making AI systems more{' '}
                <strong className="text-gray-900 dark:text-gray-100">transparent</strong>,{' '}
                <strong className="text-gray-900 dark:text-gray-100">trustworthy</strong>, and{' '}
                <strong className="text-gray-900 dark:text-gray-100">secure</strong>. My work
                bridges the gap between complex AI models and human understanding, enabling
                stakeholders to trust and effectively use AI systems.
              </p>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Developing interpretability methods for complex AI models, enabling trust and
                    compliance in production systems.
                  </p>
                </div>
                <div className="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100">
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Building transformer-based models for real-time video analysis with
                ...
                <div className="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Investigating adversarial attacks and defenses for video models to improve
                    system robustness.
                  </p>
                </div>
                <div className="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Creating frameworks for deploying XAI in production environments across Azure,
                    GCP, and AWS.
                  </p>
                </div>
              </div>
                ...
                {presentationsData.map((pres, i) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <span className="bg-primary-100 text-primary-700 dark:bg-primary-900/50 dark:text-primary-300 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium">
                          {pres.type}
                        </span>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="line-clamp-1 text-xs text-gray-500 dark:text-gray-500">
                            {venue.name}
                          </p>
                        </div>
